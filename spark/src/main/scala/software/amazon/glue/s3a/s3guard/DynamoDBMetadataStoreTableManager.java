...
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_CAPACITY_READ_DEFAULT;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_CAPACITY_READ_KEY;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_CAPACITY_WRITE_DEFAULT;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_CAPACITY_WRITE_KEY;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_CREATE_KEY;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_SSE_CMK;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_SSE_ENABLED;
import static software.amazon.glue.s3a.Constants.S3GUARD_DDB_TABLE_TAG;
import static software.amazon.glue.s3a.S3AUtils.lookupPassword;
import static software.amazon.glue.s3a.S3AUtils.translateDynamoDBException;
import static software.amazon.glue.s3a.S3AUtils.translateException;
import static software.amazon.glue.s3a.s3guard.DynamoDBMetadataStore.E_ON_DEMAND_NO_SET_CAPACITY;
import static software.amazon.glue.s3a.s3guard.DynamoDBMetadataStore.VERSION;
import static software.amazon.glue.s3a.s3guard.DynamoDBMetadataStore.VERSION_MARKER_ITEM_NAME;
import static software.amazon.glue.s3a.s3guard.DynamoDBMetadataStore.VERSION_MARKER_TAG_NAME;
import static software.amazon.glue.s3a.s3guard.PathMetadataDynamoDBTranslation.attributeDefinitions;
import static software.amazon.glue.s3a.s3guard.PathMetadataDynamoDBTranslation.createVersionMarker;
import static software.amazon.glue.s3a.s3guard.PathMetadataDynamoDBTranslation.createVersionMarkerPrimaryKey;
import static software.amazon.glue.s3a.s3guard.PathMetadataDynamoDBTranslation.extractCreationTimeFromMarker;
import static software.amazon.glue.s3a.s3guard.PathMetadataDynamoDBTranslation.extractVersionFromMarker;
import static software.amazon.glue.s3a.s3guard.PathMetadataDynamoDBTranslation.keySchema;
...
public class DynamoDBMetadataStoreTableManager {
   ...
   * {@link software.amazon.glue.s3a.Constants#S3GUARD_DDB_TABLE_CREATE_KEY} is
