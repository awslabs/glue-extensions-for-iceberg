...
import static software.amazon.glue.s3a.S3AUtils.extractException;
import static software.amazon.glue.s3a.S3AUtils.getPutRequestLength;
...
import static software.amazon.glue.s3a.Statistic.OBJECT_BULK_DELETE_REQUEST;
import static software.amazon.glue.s3a.Statistic.OBJECT_DELETE_OBJECTS;
import static software.amazon.glue.s3a.Statistic.OBJECT_DELETE_REQUEST;
import static software.amazon.glue.s3a.Statistic.OBJECT_PUT_BYTES;
import static software.amazon.glue.s3a.Statistic.OBJECT_PUT_BYTES_PENDING;
import static software.amazon.glue.s3a.Statistic.OBJECT_PUT_REQUESTS_ACTIVE;
import static software.amazon.glue.s3a.Statistic.OBJECT_PUT_REQUESTS_COMPLETED;
import static software.amazon.glue.s3a.Statistic.STORE_IO_RATE_LIMITED;
