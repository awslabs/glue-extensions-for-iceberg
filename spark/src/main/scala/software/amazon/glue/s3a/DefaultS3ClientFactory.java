...
import software.amazon.glue.s3a.impl.AWSClientConfig;
...
import static software.amazon.glue.s3a.Constants.AWS_REGION;
import static software.amazon.glue.s3a.Constants.AWS_S3_ACCESS_GRANTS_ENABLED;
import static software.amazon.glue.s3a.Constants.AWS_S3_ACCESS_GRANTS_FALLBACK_TO_IAM_ENABLED;
import static software.amazon.glue.s3a.Constants.AWS_S3_CROSS_REGION_ACCESS_ENABLED;
import static software.amazon.glue.s3a.Constants.AWS_S3_CROSS_REGION_ACCESS_ENABLED_DEFAULT;
import static software.amazon.glue.s3a.Constants.AWS_S3_DEFAULT_REGION;
import static software.amazon.glue.s3a.Constants.CENTRAL_ENDPOINT;
import static software.amazon.glue.s3a.Constants.FIPS_ENDPOINT;
import static software.amazon.glue.s3a.Constants.HTTP_SIGNER_CLASS_NAME;
import static software.amazon.glue.s3a.Constants.HTTP_SIGNER_ENABLED;
import static software.amazon.glue.s3a.Constants.HTTP_SIGNER_ENABLED_DEFAULT;
import static software.amazon.glue.s3a.Constants.DEFAULT_SECURE_CONNECTIONS;
import static software.amazon.glue.s3a.Constants.SECURE_CONNECTIONS;
import static software.amazon.glue.s3a.Constants.AWS_SERVICE_IDENTIFIER_S3;
import static software.amazon.glue.s3a.auth.SignerFactory.createHttpSigner;
import static software.amazon.glue.s3a.impl.AWSHeaders.REQUESTER_PAYS_HEADER;
import static software.amazon.glue.s3a.impl.InternalConstants.AUTH_SCHEME_AWS_SIGV_4;
