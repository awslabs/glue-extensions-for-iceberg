...
import software.amazon.glue.s3a.tools.BucketTool;
...
import static software.amazon.glue.s3a.impl.InternalConstants.S3A_DYNAMIC_CAPABILITIES;
import static software.amazon.glue.s3a.select.SelectConstants.SELECT_UNSUPPORTED;
