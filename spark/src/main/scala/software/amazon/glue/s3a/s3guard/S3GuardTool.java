...
import static software.amazon.glue.s3a.Invoker.LOG_EVENT;
import static software.amazon.glue.s3a.S3AUtils.clearBucketOption;
import static software.amazon.glue.s3a.S3AUtils.propagateBucketOptions;
import static software.amazon.glue.s3a.commit.CommitConstants.*;
import static software.amazon.glue.s3a.commit.staging.StagingCommitterConstants.FILESYSTEM_TEMP_PATH;
import static software.amazon.glue.s3a.s3guard.DynamoDBMetadataStoreTableManager.SSE_DEFAULT_MASTER_KEY;
...
import software.amazon.glue.s3a.select.SelectTool;
import software.amazon.glue.s3a.tools.MarkerTool;
