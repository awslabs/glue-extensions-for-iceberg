...
import software.amazon.glue.s3a.auth.SignerFactory;
import org.apache.hadoop.util.VersionInfo;

import static software.amazon.glue.s3a.Constants.CONNECTION_ACQUISITION_TIMEOUT;
import static software.amazon.glue.s3a.Constants.AWS_SERVICE_IDENTIFIER_S3;
import static software.amazon.glue.s3a.Constants.AWS_SERVICE_IDENTIFIER_STS;
import static software.amazon.glue.s3a.Constants.CONNECTION_IDLE_TIME;
import static software.amazon.glue.s3a.Constants.CONNECTION_KEEPALIVE;
import static software.amazon.glue.s3a.Constants.CONNECTION_TTL;
import static software.amazon.glue.s3a.Constants.DEFAULT_CONNECTION_ACQUISITION_TIMEOUT_DURATION;
import static software.amazon.glue.s3a.Constants.DEFAULT_CONNECTION_IDLE_TIME_DURATION;
import static software.amazon.glue.s3a.Constants.DEFAULT_CONNECTION_KEEPALIVE;
import static software.amazon.glue.s3a.Constants.DEFAULT_CONNECTION_TTL_DURATION;
import static software.amazon.glue.s3a.Constants.DEFAULT_ESTABLISH_TIMEOUT_DURATION;
import static software.amazon.glue.s3a.Constants.DEFAULT_MAXIMUM_CONNECTIONS;
import static software.amazon.glue.s3a.Constants.DEFAULT_MAX_ERROR_RETRIES;
import static software.amazon.glue.s3a.Constants.DEFAULT_REQUEST_TIMEOUT_DURATION;
import static software.amazon.glue.s3a.Constants.DEFAULT_SOCKET_TIMEOUT_DURATION;
import static software.amazon.glue.s3a.Constants.ESTABLISH_TIMEOUT;
import static software.amazon.glue.s3a.Constants.MAXIMUM_CONNECTIONS;
import static software.amazon.glue.s3a.Constants.MAX_ERROR_RETRIES;
import static software.amazon.glue.s3a.Constants.MINIMUM_NETWORK_OPERATION_DURATION;
import static software.amazon.glue.s3a.Constants.PROXY_DOMAIN;
import static software.amazon.glue.s3a.Constants.PROXY_HOST;
import static software.amazon.glue.s3a.Constants.PROXY_PASSWORD;
import static software.amazon.glue.s3a.Constants.PROXY_PORT;
import static software.amazon.glue.s3a.Constants.PROXY_SECURED;
import static software.amazon.glue.s3a.Constants.PROXY_USERNAME;
import static software.amazon.glue.s3a.Constants.PROXY_WORKSTATION;
import static software.amazon.glue.s3a.Constants.REQUEST_TIMEOUT;
import static software.amazon.glue.s3a.Constants.SIGNING_ALGORITHM;
import static software.amazon.glue.s3a.Constants.SIGNING_ALGORITHM_S3;
import static software.amazon.glue.s3a.Constants.SIGNING_ALGORITHM_STS;
import static software.amazon.glue.s3a.Constants.SOCKET_TIMEOUT;
import static software.amazon.glue.s3a.Constants.USER_AGENT_PREFIX;
import static software.amazon.glue.s3a.impl.ConfigurationHelper.enforceMinimumDuration;
import static software.amazon.glue.s3a.impl.ConfigurationHelper.getDuration;
